...
export const globalChangelog: ChangelogEntry[] = [
  {
    ...
    title: '日历重整假日/调休信息层级',
    notes: [
      '格子固定为「日期 + 休/班徽标 + 原有农历/节气/节日」三层：状态有明确文字，原日历信息不再被替换',
      '移除抢眼的顶部色条；假日/调休只保留低饱和浅底和弱描边，颜色退回辅助层',
      '日期与状态并排，图例明确写为「休 放假」「班 调休上班」；手机端网格横向扩展、徽标固定尺寸，避免两位数日期被挤压'
    ]
  },
  {
    date: '2026-08-28',
  ...
  },
  {
    ...
    title: '首页按用途分组',
    notes: [
      '工具改为按图片 / 文档 / 文本 / 编码 / 文件分组浏览，卡片收密，更新日志不再混在工具网格里',
      '顶栏日历入口改为搜索（Ctrl+K）'
    ]
  },
  {
