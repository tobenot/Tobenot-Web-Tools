  ...
  return (
    <div className="panel p-6">
      ...
      <div className="mt-4 grid gap-3 sm:grid-cols-2">
        <a className="panel p-4 hover:border-mech-accent/40 transition-colors" href="#calendar">
        ...
        <a className="panel p-4 hover:border-mech-accent/40 transition-colors" href="#changelog">
          <div className="flex items-center justify-between">
            <div>
              <div className="font-medium">更新日志</div>
              <div className="text-sm text-mech-muted mt-1">查看项目更新记录</div>
            </div>
            <span className="badge">站点</span>
          </div>
        </a>
      </div>
    </div>
